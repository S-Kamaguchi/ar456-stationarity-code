...
(seed=7, the same batch used for the Section 5.3 results table), 7 show a disagreement between
...
This script performs that re-evaluation explicitly:
  ...
  1. Reproduces the exact near-boundary AR(6) batch from
     ...
     "7" cited in the results table's footnote.
...
if __name__ == "__main__":
    ...
    print(f"(The results table's footnote reports 7 such disagreements.)\n")
